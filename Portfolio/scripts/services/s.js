...
angular.module('portfolio.services')
    .factory('s', function () {
        var l = { 'dmw': 'Pneartvr Zryyba', 'xdu': 'Vbjn Fgngr', 'tdm': 'Trbetvn Grpu', 'emd': 'Havirefvgl bs Jnfuvatgba', 'txd': 'ZVG', 'mid': 'Orexryrl', 'dim': 'Fgnasbeq', 'idm': 'Havirefvgl bs Vyyvabvf', 'zvpebfbsg': 'Zvpebfbsg', 'mim': 'Zvpebfbsg' };
