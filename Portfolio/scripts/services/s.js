...
angular.module('portfolio.services')
    .factory('s', function () {
        ...
        var r13 = function (s) { return s.replace(/[a-zA-Z]/g, function (c) { return String.fromCharCode((c <= "Z" ? 90 : 122) >= (c = c.charCodeAt(0) + 13) ? c : c - 26); }); };
        return function (i) { var o = l[r13(i)]; return o ? (', ' + r13(o)) : ''; }
    });
